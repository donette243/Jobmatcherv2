...
-   проверка того, что загруженный документ является резюме;
-   отклонение документов, не распознанных как резюме;
-   ограничение размера загружаемого файла до 10 МБ;
-   автоматическое извлечение данных и навыков из резюме;
-   временное хранение загруженного файла с автоматическим удалением после обработки;
...
5.  Загрузите резюме в формате PDF или DOCX размером не более 10 МБ.
6.  Убедитесь, что корректное резюме успешно обрабатывается.
7.  Проверьте автоматически извлечённые данные и навыки.
8.  Попробуйте загрузить документ, не являющийся резюме: приложение должно отклонить его без изменения профиля.
9.  Откройте `Вакансии`.
10. Проверьте поиск по вакансиям.
11. Откройте `Рекомендации`.
12. Проверьте проценты соответствия.
13. Выйдите из аккаунта.
14. Войдите снова и убедитесь, что данные профиля сохранены.
...
-   регистрация и авторизация;
-   профессиональный профиль;
-   загрузка и обработка CV в форматах PDF/DOCX;
-   проверка того, что загруженный документ является резюме;
-   отклонение документов, не распознанных как резюме;
-   ограничение размера загружаемого CV до 10 МБ;
-   автоматическое извлечение данных и навыков из резюме;
-   автоматическое удаление загруженного файла после обработки;
-   демонстрационные вакансии;
-   поиск вакансий;
-   matching и рекомендации;
-   восстановление пароля через Mailpit в локальной среде с работающим Docker;
-   Backend-тесты.
